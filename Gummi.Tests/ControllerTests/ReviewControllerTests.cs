...
namespace Gummi.Tests.ControllerTests
{
    ...
    public class ReviewsControllerTest : Controller
    {
        ...
        public void SetUpTheMockDb()
        {
            ...
            {
                new Review {ReviewId = 1, Author = "Gummy Manny", Content = "I liked it.", 5, ProductId = 1 },
                new Review {ReviewId = 2, Author = "Gummy Moe", Content = "I hated it.", 1, ProductId = 1 },
                new Review {ReviewId = 3, Author = "Gummy Jack", Content = "It's okay.", 3, ProductId = 1 }
            }.AsQueryable());
        }
